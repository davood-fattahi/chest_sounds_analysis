function  SQI= get_all_SQIs_modified(audio_data, Fs)
SQI=table;
max_HR=220;
min_HR=70;
max_RR=80;
...
try
    ...
    assigned_states=assigned_states_schmidt;
    peak_pos_springer=peak_pos_schmidt;
    warning('No heart beat is detected by springer!')
end
