...
% indicies_p_s_f=indicies_p_s(power_sys(indicies_p_s)>=mean(power_sys)); 
...
%     end
% end
% indicies_p_d_f=indicies_p_d(power_dias(indicies_p_d)>=mean(power_dias)); 
...
%     end
% end
% indicies_p_s1_f=indicies_p_s1(power_s1(indicies_p_s1)<=mean(power_s1));
