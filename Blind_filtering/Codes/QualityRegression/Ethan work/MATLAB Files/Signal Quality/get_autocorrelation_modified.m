...
function [truncated_autocorrelation, untruncated_autocorrelation, semi_truncated_autocorrelation] = get_autocorrelation_modified(audio_data, Fs,figures)
...
semi_truncated_autocorrelation = acf(first_point:end);
